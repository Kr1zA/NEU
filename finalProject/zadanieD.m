function [retVal] = zadanieD(normalizovaneBurkyNaUcenie, normalizovaneDataNaTestovanie)
...
w3 = rand(11, 1) * 2 - 1; 
  ...
  for k = 0:pocetBurok - 1
    ...
    for m = 0:100
      ...
      vystupyPouziteNaVstupe = rand(18, 1) * 2 - 1;
      ...
      for j = 1:144 - 10
        ...
        derivacia2 = (ones(1,11).-((tanh(V22)).^2));
        ...
        vystupyPouziteNaVstupe = [V1(2:10)'; V2(2:10)'];
